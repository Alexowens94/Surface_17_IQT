...
def instantiate_error_model_variable_probs(p_set_list, model):
    """
        ...
        try:
            if len(error_model['probabilities']) == len(p_set_list):
                for i, key in enumerate(error_model['probabilities']):
                    error_model_probabilities[key] = p_set_list[i]  # list of probabilities for all locations of error location type i
            else:
                raise ValueError
        except ValueError:
...
def logical_measurement(data, basis, eng, classical_lookup, quiescent, round=0):
    if basis == 'X':
...
def stabiliser_timestep_2(data, ancilla, leaked_reg, error_model, e_model_probs, rx_ind=0, ry_ind=0, rxx_ind=0):
    ...
    x_inc, xx_inc =  x_type_entangling(data[5], ancilla[6], leaked_reg, error_model, e_model_probs,
                      rx_ind,ry_ind, rxx_ind, d_leak_ind=5, a_leak_ind=6+9, cancel_data_rx=True, s=-1)
    rx_ind = x_inc
    rxx_ind = xx_inc
    x_inc, xx_inc =  x_type_entangling(data[3], ancilla[4], leaked_reg, error_model, e_model_probs,
                      rx_ind,ry_ind, rxx_ind, d_leak_ind=3, a_leak_ind=4+9, cancel_data_rx=True, s=-1)
    rx_ind = x_inc
    rxx_ind = xx_inc
    return rx_ind, rxx_ind
...
def stabiliser_timestep_4(data, ancilla, leaked_reg, error_model, e_model_probs, rx_ind=0, ry_ind=0, rxx_ind=0):
    ...
    x_inc, xx_inc =  x_type_entangling(data[4], ancilla[6], leaked_reg, error_model, e_model_probs,
                      rx_ind,ry_ind, rxx_ind, d_leak_ind=4, a_leak_ind=6+9, cancel_data_rx=True, s=-1)
    rx_ind = x_inc
    rxx_ind = xx_inc
...
def stabiliser_timestep_5(data, ancilla, leaked_reg, error_model, e_model_probs, rx_ind=0, ry_ind=0, rxx_ind=0):
    x_inc, y_inc, xx_inc = z_type_entangling(data[1], ancilla[2], leaked_reg, error_model, e_model_probs, rx_ind, ry_ind, rxx_ind,
                      d_leak_ind=1, a_leak_ind=2+9, cancel_data_rx=True, cancel_ry2=True, v=1, s=1)
    rx_ind = x_inc
    ry_ind = y_inc
    rxx_ind = xx_inc
    x_inc, y_inc, xx_inc = z_type_entangling(data[3], ancilla[5], leaked_reg, error_model, e_model_probs, rx_ind, ry_ind, rxx_ind,
                      d_leak_ind=1, a_leak_ind=2+9, v=1, s=1)
    rx_ind = x_inc
    ry_ind = y_inc
    rxx_ind = xx_inc
    x_inc, y_inc, xx_inc = z_type_entangling(data[7], ancilla[7], leaked_reg, error_model, e_model_probs, rx_ind, ry_ind, rxx_ind,
                      d_leak_ind=7, a_leak_ind=7+9, cancel_data_rx=True, cancel_ry2=True, v=1, s=1)
    rx_ind = x_inc
    ry_ind = y_inc
    rxx_ind = xx_inc
    return rx_ind, ry_ind, rxx_ind
...
def stabiliser_timestep_6(data, ancilla, leaked_reg, error_model, e_model_probs, rx_ind=0, ry_ind=0, rxx_ind=0):
    x_inc, y_inc, xx_inc = z_type_entangling(data[2], ancilla[2], leaked_reg, error_model, e_model_probs, rx_ind, ry_ind, rxx_ind,
                      d_leak_ind=2, a_leak_ind=2+9, v=1, s=-1)
    rx_ind = x_inc
    ry_ind = y_inc
    rxx_ind = xx_inc
    x_inc, y_inc, xx_inc = z_type_entangling(data[4], ancilla[5], leaked_reg, error_model, e_model_probs, rx_ind, ry_ind, rxx_ind,
                      d_leak_ind=4, a_leak_ind=5+9, cancel_data_rx=True, cancel_ry2=True, v=1, s=-1)
    rx_ind = x_inc
    ry_ind = y_inc
    rxx_ind = xx_inc
    x_inc, y_inc, xx_inc = z_type_entangling(data[8], ancilla[7], leaked_reg, error_model, e_model_probs, rx_ind, ry_ind, rxx_ind,
...
def stabiliser_timestep_7(data, ancilla, leaked_reg, error_model, e_model_probs, rx_ind=0, ry_ind=0, rxx_ind=0):
    x_inc, y_inc, xx_inc = z_type_entangling(data[4], ancilla[2], leaked_reg, error_model, e_model_probs,
                      ...
                      d_leak_ind=4, a_leak_ind=2+9, cancel_data_rx=True, cancel_ry1=True, v=1, s=1)
    rx_ind = x_inc
    ry_ind = y_inc
    rxx_ind = xx_inc
...
def stabiliser_timestep_8(data, ancilla, leaked_reg, error_model, e_model_probs, rx_ind=0, ry_ind=0, rxx_ind=0):
    ...
    x_inc, y_inc, xx_inc = z_type_entangling(data[7], ancilla[5], leaked_reg, error_model, e_model_probs,
                                                rx_ind, ry_ind, rxx_ind,
                      d_leak_ind=7, a_leak_ind=5+9, cancel_data_rx=True, cancel_ry1=True, v=1, s=-1)
    rx_ind = x_inc
    ry_ind = y_inc
    rxx_ind = xx_inc
    x_inc, y_inc, xx_inc = z_type_entangling(data[1], ancilla[0], leaked_reg, error_model, e_model_probs,
                                                rx_ind, ry_ind, rxx_ind,
                      d_leak_ind=1, a_leak_ind=0+9, cancel_data_rx=True, cancel_ry1=True, v=1, s=-1)
    rx_ind = x_inc
    ry_ind = y_inc
    rxx_ind = xx_inc
    return rx_ind, ry_ind, rxx_ind

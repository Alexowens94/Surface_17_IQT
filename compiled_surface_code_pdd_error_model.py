...
def x_type_entangling(dataq,ancillaq,s=1,pxctrl=0,pxxctrl=0,pmot=0,pd=0):
...
def z_type_entangling(dataq,ancillaq,v=1,s=1,pxctrl=0,pxxctrl=0,pyctrl=0,pmot=0,pd=0):
    Ry(v*pi/2) | dataq

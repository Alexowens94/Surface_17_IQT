...
leaked_q_reg = 17*[0]  # a register (initialised as 0s) to track which qubits  leaked, LEAKED == 1 0-8
...
for i in range(cycle_number):
    ...
    syndrome.append(stabilizer_cycle(data, ancilla, leaked_q_reg, eng, reset=True,
                                     p1q=0, p2q=0, p_leak=0))  # compiled for ion traps
